...
<template>
 <section class="">
    <div class="p-3 bg-purple-50 text-purple-700 cursor-pointer px-28 py-5 flex flex-row items-center gap-1 ">
      ...
      <div class="container m-auto max-w-2xl py-6">
        ...
        >
          <form>
            <h2 class="text-3xl text-center font-semibold mb-6">Create Job Post</h2>
