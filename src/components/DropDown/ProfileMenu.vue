<template>
  <div class="flex flex-col relative" ref="dropdown">
    <div
      class="flex flex-row items-center gap-2 border rounded-md p-2 cursor-pointer select-none"
    ...
    >
      ...
      <div class="flex flex-col">
        ...
        <span class="font-semibold text-sm">Nitesh Bhagat</span>
      </div>
      <i :class="[isOpen ? 'pi-angle-up':'pi-angle-down','pi ']"></i>
    </div>
